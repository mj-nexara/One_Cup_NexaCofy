    ...
    <section className="relative overflow-hidden py-20 px-4">
      ...
      <div className="container mx-auto text-center relative z-10">
        ...
        <p className="text-lg md:text-xl text-gray-300 mb-4 max-w-3xl mx-auto">
          <span className="text-cyan-400 font-semibold">A systematic, humanitarian, and technology-driven pathway</span>
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
          <Link href="/dashboard">
            ...
            >
              <Image src="/nexara-icon.png" alt="Nexara Icon" width={20} height={20} className="mr-2" />
